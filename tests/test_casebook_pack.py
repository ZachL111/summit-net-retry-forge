"""Regression checks for the summit-net-retry-forge casebook."""
...
from casebook.harness import assert_expected, summit_net_retry_forge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(summit_net_retry_forge_summary(), assert_expected())
