...
`summit-net-retry-forge` is centered on networking work in TypeScript. The technical target is: Design a TypeScript verification harness for retry systems, covering visual model generation, layout fixtures, and failure-oriented tests.
